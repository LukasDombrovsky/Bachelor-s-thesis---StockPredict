...
api_key = "eO934bPltfZVm88polbpVCRwFXUxBdvg08BhbhJNy1LQsYdZrGNu/6ez/DcZHJEuiabyqF+ViYVDVn8c5clH1Q==" # Replace this with the API key for the web service
authz_hdr = paste('Bearer', api_key, sep=' ')

h$reset()
curlPerform(url = "https://ussouthcentral.services.azureml.net/workspaces/b3777079b3424ee2bed9f97ca8c13c5b/services/401318f0ebe7468986839b832a6c7d69/execute?api-version=2.0&details=true",
