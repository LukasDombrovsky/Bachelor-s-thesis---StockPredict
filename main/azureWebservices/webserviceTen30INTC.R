...
api_key = "WvUT19UoynRqA8eBKWEBOlEqjKX/9y9Xbmz0w7+moA0QNUcTCLwwVCZQ5/Cwn66UC59RKvC68mSavEGqkZCxdg==" # Replace this with the API key for the web service
authz_hdr = paste('Bearer', api_key, sep=' ')

h$reset()
curlPerform(url = "https://ussouthcentral.services.azureml.net/workspaces/b3777079b3424ee2bed9f97ca8c13c5b/services/37f4445aaff548df89129d67f590041b/execute?api-version=2.0&details=true",
