...
api_key = "6RMbofGO+qkdvLig0P4mlw3XFSDdZlTViX0jj8JvtLcxzI4CjQF6gchkiWN9AiRd0dQeXuEusHsIvejI7yLufQ==" # Replace this with the API key for the web service
authz_hdr = paste('Bearer', api_key, sep=' ')

h$reset()
curlPerform(url = "https://ussouthcentral.services.azureml.net/workspaces/b3777079b3424ee2bed9f97ca8c13c5b/services/0a521a8745c84d1babcfd37c189e9ebf/execute?api-version=2.0&details=true",
